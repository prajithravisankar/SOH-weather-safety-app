...
function LocationForm() {
    ...
    return (
        <form
            ...
            className="max-w-2xl mx-auto p-6 bg-[#242424] rounded-lg shadow flex flex-col gap-4"
        ...
        >
            ...
            <div className="flex flex-col items-center w-full">
                <button
                    type="submit"
                    className="py-2 px-8 bg-indigo-600 text-white font-semibold rounded-md shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                    style={{ backgroundColor: "#646cff" }}
                >
                    Add
                </button>
                {status && (
                    <div className="text-sm text-red-400 mt-2">{status}</div>
                )}
            </div>
        </form>
    );
